  ...
  try {
    ...
    if (_0x5a2825 && _0x5a2825.length > 0x0) {
      ...
      if (_0x58c224.status === 0xc8 && _0x58c224.success) {
        ...
        _0x3460c8("𝙲𝙰𝚂𝙴𝚈𝚁𝙷𝙾𝙳𝙴𝚂 𝙸𝚂 𝙼𝚈 𝙾𝚆𝙽𝙴𝚁🍀");
      } else {
...
zokou({
  ...
  try {
    ...
    if (_0x14ddfc && _0x14ddfc.length > 0x0) {
      ...
      const _0x5734dd = await fetch("https://api.davidcyriltech.my.id/download/ytmp4?url=" + encodeURIComponent(_0x1b41fa) + "&apikey=" + "gifted_api_kt5gd63gjd8");
...
zokou({
  ...
  try {
    ...
    if (_0x5914b4 && _0x5914b4.length > 0x0) {
      ...
      const _0x1ee242 = await fetch("https://api.davidcyriltech.my.id/download/ytmp4?url=" + encodeURIComponent(_0x5225ee) + '&apikey=' + "gifted_api_kt5gd63gjd8");
